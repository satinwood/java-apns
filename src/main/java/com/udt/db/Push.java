...
public class Push  implements java.io.Serializable {
    ...
    public Push(long observerId, String type, int productId, String name, Date effectiveTime, Date expiredTime, double priceThreshold, long accountId, String email) {
    ...
    public Push(long observerId, String storePid, String storeName, String type, int productId, String name, Date effectiveTime, Date expiredTime, double priceThreshold, long accountId, String email) {
       this.observerId = observerId;
